-- These are options that are required to make the code compile.
{-# LANGUAGE TemplateHaskell #-}
{-# LANGUAGE QuasiQuotes #-}

-- This reduces the number of warning generated by the code,
-- making it easier to read the output of the compiler.
